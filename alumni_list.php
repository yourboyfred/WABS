                    ...
                    <div class="card-body">
                        <div class="row align-items-center h-100">
                            <div class="">
                                ...
                                <p class="filter-txt">Service: <b><?php echo $row['course'] ?></b></p>
                                <p class="filter-txt">Year: <b><?php echo $row['batch'] ?></b></p>
                                <p class="filter-txt">Connected<b><?php echo $row['connected_to'] ?></b></p>
                                    <br>
                                </div>
                            </div>
                        </div>
